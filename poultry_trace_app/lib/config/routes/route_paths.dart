...
class RoutePaths {
  ...
  static const String resultadoActualizacion = '/inventario-foto/resultado/:galponId';
  ...
  static String mortalidadFormPath(String galponId) => '/aves/$galponId/mortalidad';
  ...
  static String produccionFormPath(String galponId) => '/produccion/$galponId/form';
  ...
  static String alimentacionFormPath(String galponId) => '/alimentacion/$galponId/form';
  
  // Inventario foto helpers
  static String capturaPath(String galponId) => '/inventario-foto/captura/$galponId';
  static String revisionConteoPath(String galponId) => '/inventario-foto/revision/$galponId';
  static String resultadoActualizacionPath(String galponId) => '/inventario-foto/resultado/$galponId';
}
